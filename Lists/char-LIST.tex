...
\NEW{PC}{\cArcher}{ %Servant paired to Sophia-Ri
  \s\MYname	{Robin Hood}
  \s\MYfile	{Archer.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
...
\NEW{PC}{\cAssasin}{ %Servant paired to Matou
  \s\MYname	{David ???}
  \s\MYfile	{Assasin.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
  \MYsex	{\male}
  \s\MYplayer	{}
...
\NEW{PC}{\cBarth}{ %Master paird to Rider
  \s\MYname	{??? Barthomeloi}
...
\NEW{PC}{\cBezerker}{ %Servant paired to Tohsaka
  \s\MYname	{Goliath ???}
  \s\MYfile	{Bezerker.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
  \MYsex	{\male}
  \s\MYplayer	{}
...
\NEW{PC}{\cCaster}{ %Servant paired to Velvet
  \s\MYname	{Medusa ???}
  \s\MYfile	{Caster.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
...
\NEW{PC}{\cChurch}{ %Neither master nor servant for the moment
  \s\MYname	{Chuch Arbiter}
  \s\MYfile	{Church.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
  \MYsex	{\male}
  ...
  \s\MYblues	{\bHGW{}}%\bChurch{}}
  \s\MYgreens	{}
  \s\MYabils	{\aForget{}\aRetrieveCommand{}}
  \s\MYitems	{}
  \s\MYwhites	{}
  \s\MYcash	{}
...
\NEW{PC}{\cEizen}{ %Master paird to Saber
...
\NEW{PC}{\cLancer}{ %Servant paired to O'Faolan
  \s\MYname	{Celtchar ???}
  \s\MYfile	{Lancer.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
...
\NEW{PC}{\cMatou}{ %Master paired to Assasin
  \s\MYname	{??? Matou}
  \s\MYfile	{Matou.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
...
\NEW{PC}{\cFaolan}{ %Master paired to Lancer
  \s\MYname	{Caoimhe O'Faolan}
  \s\MYfile	{OFaolan.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
  \MYsex	{\male}
  \s\MYplayer	{}
...
\NEW{PC}{\cRider}{ %Servant paired to Barthomeloi
...
\NEW{PC}{\cSaber}{ %Servant paired to Eizenberg
  \s\MYname	{Napoleon ???}
  \s\MYfile	{Saber.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
...
\NEW{PC}{\cSophia}{ %Master paired to Archer
  \s\MYname	{??? Sophia-Ri}
  \s\MYfile	{Sophia-Ri.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
  \MYsex	{\male}
  \s\MYplayer	{}
...
\NEW{PC}{\cTohsaka}{ %Master paired to Bezerker
  \s\MYname	{??? Tohsaka}
...
\NEW{PC}{\cVelvet}{ %Master paired to Caster
  \s\MYname	{??? Velvet}
  \s\MYfile	{Velvet.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{a test}
