...
%Church
\NEW{Abil}{\aForget}{
  \s\MYname	{Rewrite Memories}
  \s\MYtext	{You can rewrite the memories of civilians by going to the scene of the situation, holding your hands out and and up (as if beseeching a higher power for help) and calling upon the powers that be. Spend 1 minute roleplaying a complicated magical ritual that will cause many civilians to forget what actually happened and substitute a ``rational'' alternative (like a gas leak) in their memory. {\bf This ability can only be used at the scene of the situation, and in the presence of the mage that caused it. Show them this ability when the 1 minute has elapsed.}}
  \s\MYeffect	{I cover up your mistake. Do not do it again.}
  }

\NEW{Abil}{\aRetrieveCommand}{
  \s\MYname	{Transfer Command Seal}
  \s\MYtext	{You can transfer a \iCommand{} from a dead target by placing two fingers on the target's forehead for sixty seconds and roleplaying a small magical ritual(Ask about physical contact OOC if someone is playing the body before you actually touch them). You may also transfer a \iCommand{} from yourself to a living, willing target by the same mechanic. (Yes, this does technically allow you to re-instate a mage who has no \iCommand{\MYname}s remaining.)}
  \s\MYeffect	{I transfer a command seal to me from my target, or from me to you.}
  }
