...
%Shiny
\NEW{Item}{\iGrail}{
  \s\MYname	{The Holy Grail}
  \s\MYnumber	{0000}
  \s\MYtext	{Not so much a cup, as a big, dark, ominous sphere floating in the sky. Can only be touched by servants. Should only be touched by the winner. {\bf: If you touch this object, tell a GM}}
  }
  
\NEW{Item}{\iCommand}{
  \s\MYname	{Command Seal}
  \s\MYnumber	{0000}
  \s\MYtext	{A Command Seal}
  }
